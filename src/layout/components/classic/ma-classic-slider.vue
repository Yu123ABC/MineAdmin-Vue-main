...
<template>
  ...
  >
    <div class="flex justify-center logo">
      <a-avatar class="mt-1 logoB" ><router-link to="/home"><img src="@/assets/logo.png" class="bg-white" /></router-link></a-avatar>
...
<style>
.logoB { height: 51px; border-bottom: 1px solid var(--color-border-1);    background: none;
  width: 100%;
  margin-top:0px; }
  .logoB .arco-avatar-text{
width:100%;
  }
  .logoB .arco-avatar-text img{
    display: block;
    width:85%;
  }
</style>
